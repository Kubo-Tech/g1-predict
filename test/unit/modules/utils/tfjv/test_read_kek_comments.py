...
from g1_predict.modules.utils.tfjv import read_kek_comments


def _write_kek_com(
    tmp_path: pytest.TempPathFactory, year: str, filename: str, lines: list[str]
) -> str:
...
def test_read_kek_comments_returns_empty_when_file_not_found(
